  ...
  <div class="max-w-4xl mx-auto p-20   my-10  rounded-2xl mt-10">    
    <form @submit.prevent="showModal = true" class="max-w-2xl mx-auto bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-wrap gap-3">
          <label class="inline-flex items-center">
            <input type="radio" v-model="form.venduAilleurs" value="Oui" class="hidden peer">
          ...
          <label class="inline-flex items-center">
            <input type="radio" v-model="form.venduAilleurs" value="Non" class="hidden peer">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-wrap gap-3">
          <label class="inline-flex items-center">
            <input type="radio" v-model="form.actifAilleurs" value="Oui" class="hidden peer">
          ...
          <label class="inline-flex items-center">
            <input type="radio" v-model="form.actifAilleurs" value="Non" class="hidden peer">
      ...
      <div class="mb-8">
        ...
        <div class="relative">
          ...
          <input v-model="form.valeurArticle" type="number" min="0" step="0.01" required 
    ...
    <div v-if="showModal" class="fixed inset-0  backdrop-blur-2xl  bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg w-full max-w-xl">
        ...
        <ul class="text-sm space-y-2 text-gray-700 dark:text-gray-200">
          ...
          <li><strong>Déjà vendu ailleurs:</strong> {{ form.venduAilleurs }}</li>
          <li v-if="form.venduAilleurs === 'Oui'"><strong>Où:</strong> {{ form.lieuVente }}</li>
          <li><strong>Actif ailleurs:</strong> {{ form.actifAilleurs }}</li>
          <li><strong>Email:</strong> {{ form.email }}</li>
          <li><strong>Téléphone:</strong> {{ form.telephone }}</li>
          <li><strong>Valeur unitaire:</strong> {{ form.valeurArticle }} FCFA</li>
        </ul>
...
const submitForm = async () => {
  try {
    ...
    /*
    await fetch('https://ton-backend.com/api/adhesion.php', {
      method: 'POST',
      headers: {
